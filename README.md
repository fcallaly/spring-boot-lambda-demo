...
This was created from the aws spring boot 2 maven archetype, see <https://github.com/awslabs/aws-serverless-java-container/wiki/Quick-start---Spring-Boot>

```
mvn archetype:generate -DgroupId=com.frankc.training -DartifactId=spring-boot-lambda-demo -Dversion=0.0.1-SNAPSHOT -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3
```

# lambda-demo serverless API
The lambda-demo project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=lambda-demo -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3 -DgroupId=com.frankc.training -Dversion=0.0.1-SNAPSHOT -Dinteractive=false
$ cd lambda-demo
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "LambdaDemoApi",
                    "OutputKey": "LambdaDemoApi",
